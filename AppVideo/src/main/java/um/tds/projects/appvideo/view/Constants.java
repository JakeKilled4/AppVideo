...
public class Constants {
	...
	public static final int WINDOW_X_SIZE 				= 630;
	public static final int WINDOW_Y_SIZE 				= 480;
	...
	public static final Color BUTTON_RED_HOVER_COLOR 	= new Color(191, 97, 106);
